...
appdata = [];
appdata.lastValidTag = 'executemenu_compile_codes';
h214 = uimenu(...
'Parent',h_executemenu,...
'Callback',@(hObject,eventdata)prana('executemenu_compile_codes_Callback',hObject,eventdata,guidata(hObject)),...
'Label','Compile codes',...
'Tag','executemenu_compile_codes',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
