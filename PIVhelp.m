...
if A==12
    set(handles.edit1,'String',...
       {'General: The program will save an X and Y matrix, as well as corresponding U and V matrices and an Eval matrix. The meaning of values in the Eval matrix is as follows:' '' ...
        ...
        'Multiple .mat Files:' 'U(i,j,1,t), V(i,j,1,t), (C(i,j,1,t)), and Eval(i,j,1,t) are the validated results. If additional peak information was saved, it will be tacked onto the third dimension of the relevant variable. The additional frames are stored as the fourth dimension.' ''});
end
