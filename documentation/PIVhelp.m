...
if A==10
    set(handles.edit1,'String',...
       {'General:' 'This section sets the processing controls for the PIV pass displayed in the PIV controls listbox' ''...
        ...
        'Subpixel Correlation Peak Locator:' 'Select the algorithm to use for interpolating the subpixel location of the correlation peak. The Least Squares takes the longest, but is most accurate [???].' ...
